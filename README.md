...
Transform your lecture slides, PDFs, and notes into intelligent study materials using AI. This application automatically generates summaries, flashcards, quizzes, and mind maps to make studying faster, more interactive, and personalized.
...
- 🧠 **Mind Maps**: Visual hierarchy of topics and concepts
...
2. **View Generated Content**
   - Navigate between tabs: Summary, Flashcards, Quiz, Mind Map
...
3. **Study with Interactive Tools**
   ...
   - **Mind Map**: Explore visual connections between topics
...
- Create hierarchical structures for mind maps
